...
urlpatterns = [
    ...
    path("popup/", views.redirect_to_popup, name="redirect_to_popup"),
    ...
    path(
        ...
        views.edit_personal_information,
        name="edit_personal_information",
    ),
    path("profile/email/edit/", views.edit_personal_email, name="edit_email"),
    path(
        "profile/password_set/",
        views.set_password_for_linkedin_user,
        name="set_password_for_linkedin_user",
    ),
